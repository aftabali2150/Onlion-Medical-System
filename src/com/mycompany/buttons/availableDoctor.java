...
availableDoctor(){
frame=new JFrame();
frame.setTitle("Avaiable Doctors ");
...
void initializer(){
    ...
    Title=new JLabel("List Of Available Doctors",SwingConstants.CENTER);
    ...
    backp.add(backbtn);
     ...
     JPanel bp=new JPanel(new GridLayout(4,1,2,2));
        j1.setText("NAME : DR MUHAMMAD      SPECIALIZATION : HEART Specialist");
        j2.setText("NAME : DR BANGASH       SPECIALIZATION : BRAIN Specialist");
        j3.setText("NAME : DR ALI           SPECIALIZATION : KIDNEY Specialist");
        j4.setText("NAME : DR MASOOD        SPECIALIZATION : SURGEN Specialist");
